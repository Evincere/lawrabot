...
## name: interface-design description: This skill is for interface design — dashboards, admin panels, apps, tools, and interactive products. NOT for marketing design (landing pages, marketing sites, campaigns).

## description: Use this skill when the user asks for UI design, interface layout, component styling, or visual design guidance.
