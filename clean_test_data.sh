...
# Borrar historial conversacional persistido del agente (.jsonl) de forma genérica
docker exec -i lawrabot-agent sh -c "find /app/.data -name '*.jsonl' -type f -delete 2>/dev/null"
