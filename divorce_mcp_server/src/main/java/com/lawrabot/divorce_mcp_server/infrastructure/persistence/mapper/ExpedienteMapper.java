...
public class ExpedienteMapper {
    ...
    public ExpedienteJpaEntity toEntity(Expediente domain) {
        ...
        ExpedienteJpaEntity entity = ExpedienteJpaEntity.builder()
                ...
                .marriageCertificateId(domain.getMarriageCertificateId())
                .marriageCertificateIssuanceDate(domain.getMarriageCertificateIssuanceDate())
    ...
    public Expediente toDomain(ExpedienteJpaEntity entity) {
        ...
        return Expediente.builder()
                ...
                .marriageCertificateId(entity.getMarriageCertificateId())
                .marriageCertificateIssuanceDate(entity.getMarriageCertificateIssuanceDate())
